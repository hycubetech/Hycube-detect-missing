 ...
 */
    ...
    class Hycube_Base_Model_Conflict{
        ...
        protected function _createPureClass($class, $parentClasses, $classPath, $extends){
            ...
            $purePath = $classDir . DS . "Hycube". DS . "Pure.php";
            ...
            if (!file_exists($classDir . DS . "Hycube")){
                mkdir($classDir . DS . "Hycube");
                $this->_log("Dir created: " . $classDir . DS . "Hycube");
            }
