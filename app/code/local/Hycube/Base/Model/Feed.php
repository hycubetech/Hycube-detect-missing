 ...
 * @package Hycube_Base
 */  
class Hycube_Base_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    const XML_FREQUENCY_PATH    = 'ambase/feed/check_frequency';
    const XML_LAST_UPDATE_PATH  = 'ambase/feed/last_update';
    
    const URL_NEWS        = 'http://hycube.com/feed-news.xml';
    ...
    public function checkUpdate()
    {
        ...
        if ($this->_isPromoSubscribed()) {
            ...
            $wasInstalled = gmdate('Y-m-d H:i:s', Hycube_Base_Helper_Module::baseModuleInstalled());
        ...
        Hycube_Base_Helper_Module::reload();
