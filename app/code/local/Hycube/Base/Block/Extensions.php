 ...
 * @package Hycube_Base
 */ 
class Hycube_Base_Block_Extensions extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    ...
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        foreach ($modules as $moduleName) {
            if (strstr($moduleName, 'Hycube_') === false) {
            ...
            if (in_array($moduleName, array(
                'Hycube_Base', 'Magpleasure_Common', 'Magpleasure_Searchcore'
            ))) {
                continue;
            }
    ...
    protected function _getFieldHtml($fieldset, $moduleCode)
    {
        ...
        $allExtensions = Hycube_Base_Helper_Module::getAllExtensions();
